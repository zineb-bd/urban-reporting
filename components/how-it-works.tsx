  ...
  return (
    <section className="py-12 md:py-16 px-4 relative bg-card/30">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-40 w-80 h-80 bg-[#00648E]/10 rounded-full blur-3xl" />
      </div>
            ...
            return (
              <div key={index} className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-8 left-[calc(50%+32px)] w-[calc(100%-64px)] h-1 bg-gradient-to-r from-[#00648E]/50 to-transparent" />
                )}
                ...
                <Card className="p-6 border border-border/50 bg-card/70 backdrop-blur h-full flex flex-col items-center text-center space-y-4">
                  <div className="relative">
                    <div className="w-16 h-16 rounded-full bg-[#00648E] flex items-center justify-center">
                    ...
                    <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-background border-2 border-border flex items-center justify-center">
                      <span className="text-sm font-bold text-[#00648E]">{step.number}</span>
                    </div>
                  </div>
                  <div>
