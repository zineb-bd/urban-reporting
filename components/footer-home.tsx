        ...
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center justify-center md:justify-start gap-2 text-foreground/70">
              ...
              <li className="flex items-start justify-center md:justify-start gap-2 text-foreground/70">
