    ...
    const handleStatusChange = async ()=>{
        ...
        try {
            ...
            if (interventionPhotos.length > 0) {
                for (const photoPreview of photoPreviews){
                    try {
                        ...
                        if (!photoResponse.ok) {
                            console.error("Erreur lors de l'ajout d'une photo:", photoResponse.statusText);
                        }
                    } catch (photoError) {
...
_s(TechnicienDashboard, "dfYol5jUU5RnRx5Nl/zvYnrVT0U=", false, function() {
    return [
...
//# sourceMappingURL=_a8851687._.js.map