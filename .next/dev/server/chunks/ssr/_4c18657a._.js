...
"[project]/app/signalements/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SignalementDetailPage({ params }) {
    ...
    const { user: currentUser, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
                    ...
                    try {
                        ...
                        if (!techniciensResponse.ok) {
                            ...
                            if (techniciensData && techniciensData.length > 0) {
                                console.log("📋 Liste des techniciens:", techniciensData.map((t)=>`${t.prenom} ${t.nom} (${t.email})`));
                            }
                        }
                    } catch (techError) {
...
//# sourceMappingURL=_4c18657a._.js.map