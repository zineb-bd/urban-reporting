...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Récupérer un technicien pour assignation
        User technicien = userRepository.findByEmail("technicien@mail.com").orElse(null);
        ...
        if (signalementRepository.findByUser(zineb).isEmpty()) {
            ...
            signalement1.setStatut(Signalement.Statut.NOUVEAU);
            ...
            // Signalement 2: Éclairage public
            ...
            signalement5.setStatut(Signalement.Statut.NOUVEAU);
            ...
            signalement6.setStatut(Signalement.Statut.EN_ATTENTE);
